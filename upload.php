...
$file_size = "0";
   ...
   if(isset($_FILES['file'])){
      ...
      if(empty($errors)==true) {
         ...
         $sql = "INSERT INTO upload (nama, keterangan) 
            VALUES ('$file_name' ,'$keterangan')";
...
if(isset($_GET['id'])) {
    $sql = "DELETE FROM upload WHERE id_file='".$_GET['id']."'";
    $query = mysqli_query($con, $sql);
    if( $query ) {
    // kalau berhasil alihkan ke halaman list-siswa.php
    } else {
            ...
            <div class="row">
                <div class="col-md-6">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <li>File Terkirim: <?php echo $file_name;  ?> </li>
                        <li>Ukuran File: <?php echo $file_size;  ?> </li>
                        </a>
                </div>
                <div class="col-md-6">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <a href="upload.php?id=<?php echo $product->id_file; ?>" onclick="return confirm('Are you sure?')" ><button class="btn btn-primary" type="button">Hapus</button></a></td>
                    </tr>
                </tbody>
                <?php } ?>
            </table>
